...
public class SiddhiStreamFactory {
	...
	public static <OUT> DataStream<OUT> createDataStream(SiddhiOperatorContext context,
														 DataStream<Tuple2<String, Object>> namedStream) {
		return namedStream.transform(context.getName(), context.getOutputStreamType(),
