...
/**
 * <p>Siddhi CEP Environment, provides utility methods to: initialize SiddhiCEP environment based on
 * {@link StreamExecutionEnvironment}, register {@link SiddhiStream} with field-based StreamSchema
 * and bind with physical source {@link DataStream}, define rich-featured Siddhi CEP execution plan
 * with SQL-Like query for SiddhiStreamOperator, transform and connect source DataStream to
 * SiddhiStreamOperator, register customizable siddhi plugins to extend built-in CEP functions.</p>
 *
 * @see SiddhiStream
...
public class SiddhiCEP {
	 ...
	 * @see <a href="https://docs.wso2.com/display/CEP310/Writing+Extensions+to+Siddhi">
	 *     https://docs.wso2.com/display/CEP310/Writing+Extensions+to+Siddhi</a>
	 */
